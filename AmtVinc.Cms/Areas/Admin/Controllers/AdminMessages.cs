...
public static class AdminMessages
{
    ...
    public const string ServiceSaved = "Hizmet kaydedildi.";
    public const string ServiceDeleted = "Hizmet silindi.";
    public const string ServiceSlugRequired = "Slug (URL adı) zorunludur.";

    public const string MachineCategorySaved = "Kategori kaydedildi.";
    public const string MachineCategoryDeleted = "Kategori silindi.";
    public const string MachineCategorySlugRequired = "Kategori slug'ı (URL adı) zorunludur.";

    public const string MachineSaved = "Makine kaydedildi.";
    public const string MachineDeleted = "Makine silindi.";
    public const string MachineSlugRequired = "Slug (URL adı) zorunludur.";
    public const string MachineCategoryFirst = "Önce en az bir makine kategorisi oluşturmalısınız.";
